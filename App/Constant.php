...
class Constant
{
	...
	public static $SERVING_DIRECTORY = null;
	public static $SERVING_PRIVATE_DIRECTORY = null;
	public static $SERVING_PUBLIC_DIRECTORY = null;
	...
	public static function init(): void
	{
		...
		self::$SERVING_DIRECTORY = self::$FILE_DIRECTORY . DIRECTORY_SEPARATOR . 'ServingFile';
		self::$SERVING_PRIVATE_DIRECTORY = self::$SERVING_DIRECTORY . DIRECTORY_SEPARATOR . 'Private';
		self::$SERVING_PUBLIC_DIRECTORY = self::$SERVING_DIRECTORY . DIRECTORY_SEPARATOR . 'Public';

		self::$HTML_PRIVATE_DIRECTORY = self::$SERVING_PRIVATE_DIRECTORY . DIRECTORY_SEPARATOR . 'HTML';
		self::$PHP_PRIVATE_DIRECTORY = self::$SERVING_PRIVATE_DIRECTORY . DIRECTORY_SEPARATOR . 'PHP';
		self::$XSLT_PRIVATE_DIRECTORY = self::$SERVING_PRIVATE_DIRECTORY . DIRECTORY_SEPARATOR . 'XSLT';

		self::$HTML_PUBLIC_DIRECTORY = self::$SERVING_PUBLIC_DIRECTORY . DIRECTORY_SEPARATOR . 'HTML';
		self::$PHP_PUBLIC_DIRECTORY = self::$SERVING_PUBLIC_DIRECTORY . DIRECTORY_SEPARATOR . 'PHP';
		...
		self::$SUPPLEMENT_CONFIG_PUBLIC_DIRECTORY = self::$SUPPLEMENT_CONFIG_DIRECTORY . DIRECTORY_SEPARATOR . 'Public';
